...
CH2O = st.number_input("Daily water consumption (CH2O, liters)", min_value=0.5, max_value=3.0, value=2.0, help="Enter your average daily water intake in liters.")
...
faf = st.selectbox("Physical activity frequency (FAF)", options=[0, 1, 2, 3], index=2, format_func = lambda x: {0: "No Physical Activity", 1: "Low", 2: "Moderate", 3: "High (frequent)"}[x], help="Enter the average number of hours you exercise per week.")
